...
$dbname = "SalesInvoiceDB"; // Database name
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "INSERT INTO Invoices (invoice_number, date, customer_name, mobile_no, email, city, state, payment_mode, total_amount, subtotal, total_discount, total_gst)
    ...
    if ($conn->query($sql) === TRUE) {
        ...
        if (isset($_POST['itemDescription'])) {
            ...
            foreach ($itemDescriptions as $key => $description) {
                ...
                $itemSql = "INSERT INTO InvoiceItems (invoice_id, item_description, uom, quantity, unit_price, discount, gst_percent, total_price)
