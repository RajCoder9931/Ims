    ...
    <div class="page-wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="page-heading">
                <h1 class="page-title">Product Creation</h1>
                ...
                <div class="ibox">
                    ...
                    <div class="ibox-body">
                        <form method="POST" action="process_product.php">
                            ...
                            <div class="form-row">
                                <div>
                                    <label for="product-email">Product Id:</label>
                                    <input type="text" id="product-id" name="email" placeholder="Enter Product Id" required>
                                </div>
    
                                <div>
                                    <label for="product-name">Product Name:</label>
                                    <input type="text" id="product-name" name="name" placeholder="Enter Name" required>
                                </div>
                            ...
                            <div class="form-row">
                                <div>
                                    ...
                                    <input type="text" id="product-uom" name="uom" placeholder="Enter Address" >
                                </div>
    
                                <div>
                                    <label for="product-quantity">Quantity:</label>
                                    <input type="text" id="product-quantity" name="quantity" placeholder="Enter quantity" required>
                                </div>
                            </div>
                            <div class="form-row">
                                <div>
                                    <label for="product-address">HNS Code:</label>
                                    <input type="text" id="product-Address" name="Address" placeholder="Enter Address" >
                                </div>
    
                                <div>
                                    <label for="product-discount">Discount:</label>
                                    <input type="text" id="product-discount" name="discount" placeholder="Enter discount" >
                                </div>
                            </div>
                            <div class="form-row">
                            <div>
                                  <label for="product-daily">Daily </label>
                                  <input type="text" id="product-daily" name="product-daily" placeholder="Enter Daily " required>
                                </div>
                                <div>
                                  <label for="prefrered-vendor">Prefered Vendor</label>
                                  <input type="text" id="prefrered-vendor" name="prefrered-vendor" placeholder="Enter The Vendor Name ">
                                </div>
                            </div>
                            <div class="form-row">
                                <div>
                                    <label for="product-price">Price:</label>
                                    <input type="text" id="product-price" name="product-price" placeholder="Enter Price " required>
                                    </div>
                            ...
                            <!-- Submit Button Row -->
                            <div class="form-row">
                                <button style="width:150px;" type="submit" class="btn-design">Create Product</button>
                            </div>
                        </form>
                    </div>
                </div>
