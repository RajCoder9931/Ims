                ...
                <ul class="side-menu metismenu">
                    ...
                    <li>
                        ...
                        <ul class="nav-2-level collapse">
                            ...
                            <li>
                                <a href="form_advanced.php">Employee Creation</a>
                            </li>
                            <li>
            ...
            if ($result->num_rows > 0) {
                ...
                while($row = $result->fetch_assoc()) {
                    echo "<tr>
                            ...
                            <td>" . $row["aadhar"] . "</td>
                            <td>
                                    <button class='btn btn-primary btn-sm' onclick=\"editemployees({$row['id']})\"><i class='fas fa-edit'></i></button>
                                    <button class='btn btn-danger btn-sm' onclick=\"deleteemployees({$row['id']})\"><i class='fa-solid fa-trash'></i></button>
                                </td>
                          </tr>";
                }
            } else {
