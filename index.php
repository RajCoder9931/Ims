                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="ibox bg-danger color-white widget-stat">
                            <div class="ibox-body">
                                <h2 class="m-b-5 font-strong"><?php echo $product_count; ?></h2>
                                <div class="m-b-5">NEW PRODUCTS</div><i class="ti-user widget-stat-icon"></i>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="ibox">
                            ...
                            <div class="ibox-body">
                                <table class="table table-striped table-hover">
                                    <thead>
                                        <tr>
                                        <th style="width:70%;" >Invoice Number</th>
