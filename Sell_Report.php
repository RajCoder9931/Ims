...
$sql = "SELECT i.invoice_id, i.invoice_number, i.date, i.customer_name, i.mobile_no, i.email, i.city, i.state, i.payment_mode, i.total_amount, 
        ...
        FROM saleinvoices i
        LEFT JOIN saleinvoiceitems ii ON i.invoice_id = ii.invoice_id";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['delete_invoice'])) {
        ...
        $deleteItemsSql = "DELETE FROM saleinvoiceitems WHERE invoice_id = '$invoiceId'";
        if ($conn->query($deleteItemsSql) === TRUE) {
            // Now delete the invoice
            $deleteInvoiceSql = "DELETE FROM saleinvoices WHERE invoice_id = '$invoiceId'";
        ...
        $updateInvoiceSql = "UPDATE saleinvoices 
        ...
        if ($conn->query($updateInvoiceSql) === TRUE) {
            ...
            foreach ($itemDescriptions as $key => $description) {
                ...
                $insertItemSql = "INSERT INTO saleinvoiceitems (invoice_id, item_description, uom, quantity, unit_price, discount, gst_percent, total_price)
        ...
        <div class="page-content fade-in-up">
                <div class="ibox">
                    <div class="ibox-head">
                        ...
                        <button class="btn btn-success" onclick="downloadExcel()">Download</button></div>
                    <div class="ibox-body">
                        <table>
                            <thead>
                                <tr>
                                ...
                                <?php foreach ($invoices as $invoiceId => $items): ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <!-- Add Delete Button -->
                                            <form action="Sell_Report.php" method="POST" style="display:inline;">
...
<script>
    ...
    function downloadExcel() {
        ...
        XLSX.writeFile(wb, "Sell_report.xlsx");
