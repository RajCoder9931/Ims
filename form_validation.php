    ...
    <div class="page-wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="page-heading">
                <h1 class="page-title">Employee Creation</h1>
            ...
            <div class="page-content fade-in-up">
                ...
                <div class="ibox">
                    <div class="ibox-head">
                        <div class="ibox-title">Employee Form</div>
                        ...
                        <form method="POST" action="process_employee.php">
                            ...
                            <div class="form-row">
                                <div>
                                    ...
                                    <input type="text" id="employee-name" name="name" placeholder="Enter Name" required>
                                </div>
                                <div>
                                    <label for="employee-email">Email:</label>
                                    <input type="email" id="employee-email" name="email" placeholder="Enter Email" required>
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div>
                                    ...
                                    <input type="tel" id="employee-contact" name="contact" placeholder="Enter Contact" required>
                                </div>
                               
                                <div>
                                    <label for="employee-branch">Date Of Birth:</label>
                                    <input type="date" id="employee-dob" name="dob" placeholder="Enter Date Of Birth" required>
                                </div>
            
                            </div>
                            <div class="form-row">
                                <div>
                                    <label for="employee-aadhar">Aadhar Number:</label>
                                    <input type="text" id="employee-aadhar" name="aadhar" placeholder="Enter Aadhar Number" required>
                                </div>
                                <div>
                            ...
                            <div class="form-row">
                                <div>
                                    <label for="employee-father-name">Father's Name:</label>
                                    <input type="text" id="employee-father-name" name="father_name" placeholder="Enter Father's Name" required>
                                </div>
                                <div>
                                    <label for="employee-address">Address:</label>
                                    <textarea id="employee-address" name="address" placeholder="Enter Address" required></textarea>
                                </div>
                            </div>
            
                            <!-- Submit Button Row -->
                            <div class="form-row">
                                <button type="submit" class="btn-design">Create employee</button>
                            </div>
                        </form>
                    </div>
                </div>
